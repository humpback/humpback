...
func parseNodeActivityContent(info *ActivityNodeInfo) (string, any, any) {
    ...
    if info.OldNodeInfo != nil {
        oldContent = map[string]any{
            ...
            "Token":     info.OldNodeInfo.RegisterInfo.Token,
        }
    }
    if info.NewNodeInfo != nil {
        newContent = map[string]any{
            ...
            "Token":     info.NewNodeInfo.RegisterInfo.Token,
        }
    }
    ...
    case types.ActivityActionRefreshRegisterToken:
        return "Refresh register token.", oldContent, newContent
