...
const (
    ...
    CodeNodesOnceCreateLimit10     = "R4Nodes-005"
    CodeNodesLabelKeyIsEmpty       = "R4Nodes-006"
    CodeNodesLabelValueIsEmpty     = "R4Nodes-007"
    CodeNodesLabelKeyIsDuplicated  = "R4Nodes-008"
    CodeNodesIpAddressAlreadyExist = "R4Nodes-009"
    CodeNodesIsRegistered          = "R4Nodes-0010"
    ...
    CodeServiceHostPortIsDuplicated              = "R4Service-013"
    CodeServiceContainerVolumeNotEmpty           = "R4Service-014"
    CodeServiceContainerVolumeIsDuplicated       = "R4Service-015"
    CodeServiceContainerVolumeTypeInvlaid        = "R4Service-016"
    CodeServiceHostVolumeNotEmpty                = "R4Service-017"
    CodeServiceLabelNameNotEmpty                 = "R4Service-018"
    CodeServiceLabelValueNotEmpty                = "R4Service-019"
    CodeServiceResourceMemoryLimitLimitMax       = "R4Service-020"
    CodeServiceResourceMemoryReservationLimitMax = "R4Service-021"
    CodeServiceResourceMaxCpuUsageInvalid        = "R4Service-022"
    CodeServiceDispatchModeInvalid               = "R4Service-023"
    CodeServiceInstanceNumInvalid                = "R4Service-024"
    CodeServicePlacementModeInvalid              = "R4Service-025"
    CodeServicePlacementLabelNotEmpty            = "R4Service-026"
    CodeServicePlacementValueNotEmpty            = "R4Service-027"
    CodeServiceScheduleCronNotEmpty              = "R4Service-028"
    CodeServiceScheduleCronInvalid               = "R4Service-029"
    CodeServiceScheduleTimeoutInvalid            = "R4Service-030"
    CodeServiceProtocolInvalid                   = "R4Service-031"
    CodeServiceOperateInvalid                    = "R4Service-032"
    CodeServiceIsNotEnable                       = "R4Service-033"
    CodeServiceIsEnabled                         = "R4Service-034"
    CodeServiceIsDisabled                        = "R4Service-035"
