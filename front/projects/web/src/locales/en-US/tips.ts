export default {
  tips: {
    ...
    "addNodesTips":
      "A maximum of 10 nodes can be added at a time, and the registration and authentication must be completed within 30 minutes after the addition is successful, otherwise it will become invalid.",
    "addNodesSuccessTips": "Added successfully! Please complete the <span class='keywords-primary'>humpback-agent</span> installation within 30 minutes.",
